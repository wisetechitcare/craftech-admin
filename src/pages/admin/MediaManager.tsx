      ...
      <div className="flex flex-col sm:flex-row sm:items-end gap-4">
        <div className="flex-1">
          ...
          <p className="text-sm mt-1" style={{ color: "#7386a0" }}>
            {formatCount(totalImages, "image", "images")} ·{" "}
            {formatCount(totalVideos, "video", "videos")} across{" "}
          ...
          return (
            ...
            >
              ...
              <button
                ...
                style={{
                  background: isOpen ? "rgba(196,27,31,0.04)" : "transparent",
                }}
                onMouseEnter={(e) =>
                  !isOpen && (e.currentTarget.style.background = "#9fb0c4")
                }
                onMouseLeave={(e) =>
                          ...
                          {project.images.map((url: string, i: number) => (
                            ...
                            >
                              <img
                                ...
                                style={{ background: "#f6f8fb" }}
                              />
                              <p className="flex-1 text-xs text-ink truncate">
                                {url.split("/").pop()}
                              </p>
                              <a
                                href={url}
