    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-ink-mute">
          The animated counters below the Hero. The value is counted up from
          zero, so it should start with a number.
        </p>
      </div>
      ...
      >
        ...
        {stats.length === 0 && (
          <p className="text-sm text-ink-mute">
            No statistics yet — the website falls back to its defaults.
          </p>
        )}
          ...
          {stats.map((stat, i) => (
            <div key={i} className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <InputField
                  type="text"
                  placeholder="Label (e.g. Projects Executed)"
                  value={stat.label}
