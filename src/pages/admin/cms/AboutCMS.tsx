  ...
  useEffect(() => {
    ...
    appearanceApi
      ...
      .then(({ data }) => {
        ...
        setVisibility(map);
        setSections(
          record.visibilityOptions?.find((group) => group.key === "about")
            ?.sections ?? [],
        );
      })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        toast.error(
          "Content saved, but section visibility did not. Try again.",
        );
        return;
      }
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="max-h-[calc(100vh-11rem)] overflow-y-auto rounded-lg">
            <SitePreview
              ...
              draft={{
                ...
                appearance: { aboutVariant: variant, visibility },
              }}
              viewportHeight={3200}
            />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 xl:col-span-3">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <InputField
                ...
                value={story.label}
                onChange={(e) =>
                  patchSection("story", { label: e.target.value })
                }
                maxChars={rules.label.max}
              ...
              <InputField
                ...
                value={story.heading}
                onChange={(e) =>
                  patchSection("story", { heading: e.target.value })
                }
                maxChars={rules.heading.max}
            ...
            <TextArea
              ...
              onChange={(e) =>
                patchSection("story", { description: e.target.value })
              }
              ...
              <div className="flex gap-2">
                <div className="flex-1 min-w-0">
                  <InputField
                    ...
                    value={story.image}
                    onChange={(e) =>
                      patchSection("story", { image: e.target.value })
                    }
                  />
                </div>
                <button
            ...
            <InputField
              ...
              value={story.caption}
              onChange={(e) =>
                patchSection("story", { caption: e.target.value })
              }
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className={HEADING}>
                  Stats{" "}
                  <span className="text-ink-faint normal-case font-normal">
                    ({stats.length}/{rules.lists.stats.max})
                  </span>
                </h3>
                <p className="mt-1 text-[11px] text-ink-faint">
                  The metrics band. Type the value exactly as it should read,
                  e.g. "25+".
                </p>
              </div>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <InputField
                      ...
                      onChange={(e) =>
                        patch({
                          stats: patchAt(stats, i, { value: e.target.value }),
                        })
                      }
                    ...
                    <InputField
                      ...
                      onChange={(e) =>
                        patch({
                          stats: patchAt(stats, i, { label: e.target.value }),
                        })
                      }
            ...
            <div className="pt-1 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-[11px] text-ink-faint">
                    Listed in order. The first is also the badge on the story
                    image; Floating shows the second as its accent figure.
                  </p>
                </div>
                <AddButton
                  label="Add Detail"
            ...
            <div className="pt-1 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-[11px] text-ink-faint">
                    Shown beside the statement, or as their own band in
                    Floating.
                  </p>
                </div>
                <AddButton
              ...
              {values.items.map((value, i) => (
                <ListRow
                  ...
                  onMove={(from, to) =>
                    patchSection("values", {
                      items: move(values.items, from, to),
                    })
                  }
                  onRemove={(index) =>
                    patchSection("values", {
                      items: removeAt(values.items, index),
                    })
                  }
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <InputField
                      ...
                      hint={errors[`values.items.${i}.icon`]}
                      tooltip="Font Awesome name, e.g. shield-halved. Leave empty for the default."
                    />
                  </div>
                  <TextArea
                    label="Description"
          ...
          <div className={CARD}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-[11px] text-ink-faint">
                  The services list. Shown in the order below.
                </p>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="space-y-4">
              {whatWeDo.items.map((item, i) => (
                <ListRow
                  ...
                  onMove={(from, to) =>
                    patchSection("whatWeDo", {
                      items: move(whatWeDo.items, from, to),
                    })
                  }
                  onRemove={(index) =>
                    patchSection("whatWeDo", {
                      items: removeAt(whatWeDo.items, index),
                    })
                  }
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <InputField
                      ...
                      hint={errors[`whatWeDo.items.${i}.icon`]}
                      tooltip="Font Awesome name, e.g. layer-group."
                    />
                  </div>
                  <TextArea
                    label="Description"
          ...
          <div className={CARD}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-[11px] text-ink-faint">
                  The reasons list. Shown in the order below.
                </p>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="space-y-4">
              {whyChooseUs.items.map((item, i) => (
                <ListRow
                  ...
                  onMove={(from, to) =>
                    patchSection("whyChooseUs", {
                      items: move(whyChooseUs.items, from, to),
                    })
                  }
                  onRemove={(index) =>
                    patchSection("whyChooseUs", {
                      items: removeAt(whyChooseUs.items, index),
                    })
                  }
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <InputField
                      ...
                      onChange={(e) =>
                        patchSection("whyChooseUs", {
                          items: patchAt(whyChooseUs.items, i, {
                            title: e.target.value,
                          }),
                        })
                      }
                    ...
                    <InputField
                      ...
                      hint={errors[`whyChooseUs.items.${i}.icon`]}
                      tooltip="Font Awesome name, e.g. circle-check."
                    />
                  </div>
                  <TextArea
                    label="Description"
          ...
          <div className={CARD}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-[11px] text-ink-faint">
                  The process steps, in the order they are performed.
                </p>
              </div>
              <div className="flex items-center gap-3">
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <InputField
                      ...
                      tooltip={
                        'Printed as written — "01" reads better than "1".'
                      }
                    />
          ...
          >
            ...
            <TextArea
              ...
              onChange={(e) =>
                patchSection("cta", { description: e.target.value })
              }
      ...
      <MediaPickerModal
        ...
        onSelect={(url) => patchSection("story", { image: url })}
      />
    </div>
  );
}
