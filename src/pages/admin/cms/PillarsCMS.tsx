    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-ink-mute">
            Manage the fundamental values of Craftech.
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {items.map((item) => (
          <div
            key={item._id}
            className="bg-paper border border-line rounded-2xl p-6 relative group hover:border-navy/50 transition-all"
          >
          ...
          <div className="bg-paper border border-line rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              ...
              <div className="pt-4 flex gap-4">
                <button
                  type="submit"
                  className="flex-1 py-4 bg-navy hover:bg-navy-light text-white font-semibold rounded-2xl transition-all shadow-lg shadow-indigo-500/20"
                >
