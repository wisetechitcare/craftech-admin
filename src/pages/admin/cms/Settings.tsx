  ...
  return (
    <div className="max-w-5xl space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-ink-mute mt-1">Manage all company information, contact details, and website configuration</p>
      </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <InputField
                ...
                onChange={(e: any) => setData({ ...data, foundedYear: parseInt(e.target.value) })}
              />
              <InputField
                label="Years of Experience"
                type="number"
                value={data?.yearsExperience}
                onChange={(e: any) => setData({ ...data, yearsExperience: parseInt(e.target.value) })}
              />
              <InputField
                label="Total Projects Completed"
                type="number"
                value={data?.totalProjects}
                onChange={(e: any) => setData({ ...data, totalProjects: parseInt(e.target.value) })}
              />
              <div className="md:col-span-2">
                <InputField
                  label="Company Tagline"
                  value={data?.companyTagline}
                  onChange={(e: any) => setData({ ...data, companyTagline: e.target.value })}
                  placeholder="e.g., 'Building Legacy, Engineering Trust'"
                />
              </div>
              <div className="md:col-span-2">
                <label className="block text-xs font-semibold text-ink-mute uppercase tracking-wider mb-2">Company Description</label>
                <textarea
                  className="w-full px-4 py-2 bg-paper border border-line rounded-lg text-ink text-sm focus:border-info focus:outline-none transition-colors"
                  rows={3}
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <InputField
                ...
                onChange={(e: any) => setData({ ...data, primaryPhone: e.target.value })}
                required
              ...
              <InputField
                ...
                onChange={(e: any) => setData({ ...data, alternatePhone: e.target.value })}
                placeholder="+91 XXXXXXXXXX"
              />
              <InputField
                label="WhatsApp Number"
                value={data?.whatsappNumber}
                onChange={(e: any) => setData({ ...data, whatsappNumber: e.target.value })}
                placeholder="+91 93248 77493"
              />
              <InputField
                label="Office Phone"
                value={data?.officePhone}
                onChange={(e: any) => setData({ ...data, officePhone: e.target.value })}
              />
              <InputField
                label="Business Email"
                type="email"
                value={data?.businessEmail}
                onChange={(e: any) => setData({ ...data, businessEmail: e.target.value })}
                required
              />
              <InputField
                label="Support Email"
                ...
                onChange={(e: any) => setData({ ...data, supportEmail: e.target.value })}
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                <InputField
                  ...
                  onChange={(e: any) => setData({ ...data, officeAddress: e.target.value })}
                  required
              ...
              <div className="md:col-span-2">
                <InputField
                  ...
                  onChange={(e: any) => setData({ ...data, mapEmbedUrl: e.target.value })}
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <InputField
                ...
                onChange={(e: any) => setData({ ...data, socialLinks: { ...data.socialLinks, instagram: e.target.value } })}
                placeholder="https://instagram.com/..."
              />
              <InputField
                label="LinkedIn"
                value={data?.socialLinks?.linkedin}
                onChange={(e: any) => setData({ ...data, socialLinks: { ...data.socialLinks, linkedin: e.target.value } })}
                placeholder="https://linkedin.com/company/..."
              />
              <InputField
                label="Facebook"
                value={data?.socialLinks?.facebook}
                onChange={(e: any) => setData({ ...data, socialLinks: { ...data.socialLinks, facebook: e.target.value } })}
                placeholder="https://facebook.com/..."
              />
              <InputField
                label="Twitter"
                value={data?.socialLinks?.twitter}
                onChange={(e: any) => setData({ ...data, socialLinks: { ...data.socialLinks, twitter: e.target.value } })}
          ...
          <>
            ...
            <div className="space-y-3">
              {['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map(day => (
                <div key={day} className="flex items-end gap-3 p-3 bg-raise rounded-lg">
                  <div className="flex-1">
                    <label className="block text-xs font-semibold text-ink-mute uppercase tracking-wider mb-1 capitalize">{day}</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                <InputField
                  ...
                  onChange={(e: any) => setData({ ...data, primaryCTA: { ...data.primaryCTA, text: e.target.value } })}
              ...
              <SelectField
                ...
                onChange={(e: any) => setData({ ...data, primaryCTA: { ...data.primaryCTA, action: e.target.value } })}
                options={[
              ...
              <InputField
                ...
                onChange={(e: any) => setData({ ...data, primaryCTA: { ...data.primaryCTA, target: e.target.value } })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                <InputField
                  ...
                  onChange={(e: any) => setData({ ...data, secondaryCTA: { ...data.secondaryCTA, text: e.target.value } })}
              ...
              <SelectField
                ...
                onChange={(e: any) => setData({ ...data, secondaryCTA: { ...data.secondaryCTA, action: e.target.value } })}
                options={[
                  { value: 'scroll', label: 'Scroll to Section' },
              ...
              <InputField
                ...
                onChange={(e: any) => setData({ ...data, secondaryCTA: { ...data.secondaryCTA, target: e.target.value } })}
        ...
        {activeTab === 'footer' && (
          <>
            ...
            <div className="space-y-5">
              <div>
                <label className="block text-xs font-semibold text-ink-mute uppercase tracking-wider mb-2">Copyright Text</label>
                <input
                  type="text"
                  className="w-full px-4 py-2 bg-paper border border-line rounded-lg text-ink text-sm focus:border-info focus:outline-none transition-colors"
              ...
              <div>
                <label className="block text-xs font-semibold text-ink-mute uppercase tracking-wider mb-2">Footer Text</label>
                <textarea
                  className="w-full px-4 py-2 bg-paper border border-line rounded-lg text-ink text-sm focus:border-info focus:outline-none transition-colors"
                  rows={2}
              ...
              <InputField
                ...
                onChange={(e: any) => setData({ ...data, privacyPolicyUrl: e.target.value })}
                placeholder="https://..."
              />
              <InputField
                label="Terms of Service URL"
                value={data?.termsOfServiceUrl}
                onChange={(e: any) => setData({ ...data, termsOfServiceUrl: e.target.value })}
                placeholder="https://..."
              />
            </div>
          </>
          ...
          <>
            ...
            <div className="space-y-5">
              <InputField
                ...
                onChange={(e: any) => setData({ ...data, seoDefaultTitle: e.target.value })}
              />
              <div>
                <label className="block text-xs font-semibold text-ink-mute uppercase tracking-wider mb-2">Default Meta Description</label>
                <textarea
                  className="w-full px-4 py-2 bg-paper border border-line rounded-lg text-ink text-sm focus:border-info focus:outline-none transition-colors"
                  rows={2}
              ...
              <InputField
                ...
                onChange={(e: any) => setData({ ...data, googleAnalyticsId: e.target.value })}
                placeholder="G-XXXXXXXXXX"
              />
              <InputField
                label="Google Search Console ID"
                value={data?.googleSearchConsoleId}
                onChange={(e: any) => setData({ ...data, googleSearchConsoleId: e.target.value })}
              />
            </div>
          </>
        )}
          ...
          <>
            ...
            <div className="space-y-4">
              <CheckboxField
                ...
                checked={data?.isLive}
                onChange={(e: any) => setData({ ...data, isLive: e.target.checked })}
              />
              <CheckboxField
                label="Maintenance Mode"
                checked={data?.maintenanceMode}
                onChange={(e: any) => setData({ ...data, maintenanceMode: e.target.checked })}
              />
              {data?.maintenanceMode && (
                <InputField
                  label="Maintenance Message"
                  value={data?.maintenanceMessage}
                  onChange={(e: any) => setData({ ...data, maintenanceMessage: e.target.value })}
              ...
              <CheckboxField
                ...
                onChange={(e: any) => setData({ ...data, notifyOnNewLead: e.target.checked })}
              />
              {data?.notifyOnNewLead && (
                <InputField
                  ...
                  onChange={(e: any) => setData({ ...data, leadNotificationEmail: e.target.value })}
