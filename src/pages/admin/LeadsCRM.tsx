    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-8">
        {statuses.map((status) => (
          <div
            key={status}
            className="bg-white p-4 rounded-lg border border-line"
          >
            <div className="text-2xl font-semibold text-navy">
              {leads[status]?.length || 0}
            </div>
            <div className="text-xs font-bold text-mid uppercase tracking-[0.18em]">
              {status}
            </div>
          </div>
        ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6 overflow-x-auto pb-4">
        {statuses.map((status) => (
          <div
            key={status}
            className="bg-gray-50 rounded-xl p-4 min-w-[300px] md:min-w-0"
          >
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-xs font-bold text-mid uppercase mb-1">
                    Email
                  </div>
              ...
              {/* Message */}
              <div>
                <div className="text-xs font-bold text-mid uppercase mb-2">
                  Message
                </div>
                <div className="bg-gray-50 p-3 rounded-lg text-sm text-navy">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <SelectField
                    ...
                    triggerClassName="font-medium text-navy"
                  />
                </div>
                <InputField
                  label="Assigned To"
                  ...
                  onBlur={() =>
                    updateLeadNotes(selectedLead._id, selectedLead.notes)
                  }
