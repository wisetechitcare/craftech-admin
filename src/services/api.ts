...
export const contentApi = {
  ...
  updatePillar: (id: string, data: any) =>
    api.put(`/content/pillars/${id}`, data),
...
export const cmsApi = {
  ...
  updateProcessStep: (id: string, data: any) =>
    api.put(`/cms/process-steps/${id}`, data),
  ...
  updateWhyFeature: (id: string, data: any) =>
    api.put(`/cms/why-features/${id}`, data),
...
export const appearanceApi = {
  get: () =>
    api.get<{ success: boolean; message?: string; data: AppearanceResponse }>(
      "/cms/appearance",
    ),
  update: (data: AppearanceUpdatePayload) =>
    api.put<{ success: boolean; message?: string; data: AppearanceResponse }>(
      "/cms/appearance",
      data,
    ),
};
...
export const aboutApi = {
  ...
  update: (data: AboutContent) =>
    api.put<{ success: boolean; data: AboutResponse }>("/cms/about", data),
};
...
export const blogApi = {
  ...
  getByCategory: (cat: string, params?: any) =>
    api.get(`/cms/blog/category/${cat}`, { params }),
...
export const mediaApi = {
  ...
  getByCategory: (cat: string, params?: any) =>
    api.get(`/cms/media/category/${cat}`, { params }),
...
export const analyticsApi = {
  ...
  conversionBySource: (params?: any) =>
    api.get("/cms/analytics/conversion-by-source", { params }),
  responseTime: (params?: any) =>
    api.get("/cms/analytics/response-time", { params }),
  statusDistribution: (params?: any) =>
    api.get("/cms/analytics/status-distribution", { params }),
  exportCsv: (params?: any) =>
    api.get("/cms/analytics/export", { params, responseType: "blob" }),
};
